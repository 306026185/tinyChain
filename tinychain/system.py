...
from tinychain.utils import get_local_time 
...
def get_heartbeat(reason="Automated timer", include_location=False, location_name="Shenyang, LiaoNing, China"):
...
def get_login_event(last_login="Never (first login)", include_location=False, location_name="Shenyang, LiaoNing, China"):
    # Package the message with time and location
    formatted_time = get_local_time()
    packaged_message = {
        "type": "login",
