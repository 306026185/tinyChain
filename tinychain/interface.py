...
from tinychain.constants import CLI_WARNING_PREFIX, JSON_LOADS_STRICT
...
class CLIInterface(AgentInterface):
    ...
    @staticmethod
    def internal_monologue(msg: str, msg_obj: Optional[RecordMessage] = None):
    ...
    @staticmethod
    def assistant_message(msg: str, msg_obj: Optional[RecordMessage] = None):
    ...
    @staticmethod
    def memory_message(msg: str, msg_obj: Optional[RecordMessage] = None):
    ...
    @staticmethod
    def system_message(msg: str, msg_obj: Optional[RecordMessage] = None):
    ...
    @staticmethod
    def user_message(msg: str, msg_obj: Optional[RecordMessage] = None, raw: bool = False, dump: bool = False, debug: bool = DEBUG):
    ...
    @staticmethod
    def function_message(msg: str, msg_obj: Optional[RecordMessage] = None, debug: bool = DEBUG):
    ...
    @staticmethod
    def print_messages(message_sequence: List[RecordMessage], dump=False):
    ...
    @staticmethod
    def print_messages_simple(message_sequence: List[RecordMessage]):
        # rewrite to dict format
        message_sequence = [msg.to_openai_dict() for msg in message_sequence]
    ...
    @staticmethod
    def print_messages_raw(message_sequence: List[RecordMessage]):
        # rewrite to dict format
        message_sequence = [msg.to_openai_dict() for msg in message_sequence]
