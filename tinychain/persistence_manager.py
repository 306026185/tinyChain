...
from tinychain.data_type import AgentState, RecordMessage
from tinychain.memory import BaseRecallMemory, EmbeddingArchivalMemory
...
class LocalStateManager(PersistenceManager):
    ...
    '''
    def json_to_message(self, message_json) -> RecordMessage:
        """Convert agent message JSON into RecordMessage object"""
    ...
    def prepend_to_messages(self, added_messages: List[RecordMessage]):
    ...
    def append_to_messages(self, added_messages: List[RecordMessage]):
        # first tag with timestamps
        # added_messages = [{"timestamp": get_local_time(), "message": msg} for msg in added_messages]
    ...
    def swap_system_message(self, new_system_message: RecordMessage):
        # first tag with timestamps
